...
If a vehicle has exited the "city boundaries", the system should disregard any GPS emissions from that vehicle. The city boundary is currently assumed to be a 50km radius around door2door's office which is located at latitude 52.53 and longitude 13.403.
